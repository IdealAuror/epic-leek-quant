"""
P4-PL-2026Q2-v2-AllA-F2F5F6-baseline — Phase 4 V2 三因子实验策略
================================================================================
聚宽【策略回测】环境直接粘贴运行，无外部依赖。

spec_id: P4-PL-2026Q2-v2-AllA-F2F5F6-baseline
基线: P4-PL-2026Q2-v2-AllA-baseline（F2+F5 双因子，Sharpe 0.61）
...
风险提示
================================================================================
  - F6-MOM IC 验证尚未完成（脚本：research/scripts/P1-F6-MOM-2026Q2-v1-ic_analysis-standalone.py）
  - 若 IC NW-t < 2，则 F6 不是独立 alpha 因子，三因子合成可能劣化
  - A 股小盘反转效应可能影响 MOM 效力（已通过流动性过滤剔除小盘）
  - 三因子等权是简单方案，若 IC 验证通过可考虑 ICIR 加权或 Risk Parity
"""
