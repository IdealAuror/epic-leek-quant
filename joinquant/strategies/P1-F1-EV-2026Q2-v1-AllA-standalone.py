"""
P1-F1-EV-2026Q2-v1-AllA — EV<0 因子策略（全A股样本，standalone）
====================================================================
聚宽策略编辑器直接粘贴运行，无外部依赖。

spec_id: P1-F1-EV-2026Q2-v1-AllA
样本: 全A股（get_all_securities，剔除 ST/次新股）
基准: 000985.XSHG（中证全指）
...
def get_stock_pool(index_id, date_str, min_listed_days=180):
    """构建股票池：指数成分股 - ST - 次新股。index_id=None 表示全A。"""
    if index_id is None:
